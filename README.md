...
Status: Phase 1 (data acquisition and audit), Phase 2 (baseline and candidate models), and Phase 3 (era normalization) complete. Phase 4 (validation) part 1 (walk-forward out-of-sample results) complete; spread comparison and adversarial audit still to come.
